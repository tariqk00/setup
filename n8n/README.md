...
2.  **Networking (Cloudflare Tunnel)**:
    ...
    *   **Result**: Access n8n at `https://n8n.yourdomain.com`. Use THIS URL for your Google OAuth Redirect URIs.
...
3.  **Setup Credentials**:
    *   **Gmail Node**: Create new credentials.
        ...
        *   **Redirect URI**: Must match `https://n8n.yourdomain.com/rest/oauth2-credential/callback` (using your Cloudflare domain).
